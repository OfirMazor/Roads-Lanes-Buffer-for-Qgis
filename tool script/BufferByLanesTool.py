...
class BufferByLanes(ProcessingAlgorithm):
    ...
    def shortHelpString(self):
        ...
        """
        ToolHelp = "The algorithm takes line geometry layer with 2 numeric columns of lanes (FT, TF) number as weights for side-buffering the lines where each side get it's weight"
